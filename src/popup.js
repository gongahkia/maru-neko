...
var pageQuote = document.querySelector(".quote");
var pageQuoteAuthor = document.querySelector(".quoteAuthor");
...
const motivationalQuoteSeed = getRandomInt(0,motivationalQuoteArray.length-1);
const chosenQuote = motivationalQuoteArray[motivationalQuoteSeed].quote;
const chosenAuthor = motivationalQuoteArray[motivationalQuoteSeed].author;
...
function changeQuote() {
    pageQuote.textContent = chosenQuote;
}

function changeAuthor() {
    pageQuoteAuthor.textContent = chosenAuthor;
}
